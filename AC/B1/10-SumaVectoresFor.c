/* 10-SumaVectoresFor.c
Suma de dos vectores: v3 = v1 + v2
Para compilar usar (-lrt: real time library):
gcc -O2 10-SumaVectoresFor.c -o 10-SumaVectoresFor -lrt
gcc -O2 –S 10-SumaVectoresFor.c –lrt   //para generar el código ensamblador
Para ejecutar use: 10-SumaVectoresFor longitud
*/
