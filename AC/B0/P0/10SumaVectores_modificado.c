/* 10SumaVectores_modificado.c
Suma de dos vectores: v3 = v1 + v2
Para compilar usar (-lrt: real time library):
gcc -O2 10SumaVectores_modificado.c -o 10SumaVectores_modificado -lrt
gcc -O2 –S 10SumaVectores_modificado.c –lrt   //para generar el código ensamblador
Para ejecutar use: 10SumaVectores_modificado longitud
*/
