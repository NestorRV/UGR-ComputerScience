	...
	switch (modo){
		case 1: //Puntos
			if(objeto == 'c')
				...
				tetraedro.draw_puntos(1.0, 0.5, 0.0, 10.0);
			else if(objeto == 'e')
				tronco_piramide.draw_puntos(1.0, 0.5, 0.0, 10.0);
			break;
		case 2: //Aristas
			if(objeto == 'c')
				...
				tetraedro.draw_aristas(0, 0, 0, 2.0);
			else if(objeto == 'e')
				tronco_piramide.draw_aristas(0, 0, 0, 2.0);
			break;
		case 3: //Solido
			if(objeto == 'c')
				...
				tetraedro.draw_solido(100, 0, 30);
			else if(objeto == 'e')
				tronco_piramide.draw_solido(100, 0, 30);
			break;
		case 4: //Solido Ajedrez
			if(objeto == 'c')
				...
				tetraedro.draw_solido_ajedrez(100, 0, 30, 0, 0, 0);
			else if(objeto == 'e')
				tronco_piramide.draw_solido_ajedrez(100, 0, 30, 0, 0, 0);
			break;
		case 5: //Solido aleatorio
			if(objeto == 'c')
				cubo.draw_aleatorio();
			else if(objeto == 'p')
				piramide.draw_aleatorio();
			else if(objeto == 't')
				tetraedro.draw_aleatorio();
			else if(objeto == 'e')
				tronco_piramide.draw_aleatorio();
			break;
	}
}
