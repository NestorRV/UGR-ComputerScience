...
public:
   ...
   void selectNode(nodeOfFrontier &selectedNode, bool lejos); //Método que selecciona un nodo de la frontera para establecer el objetivo al que debe navegar el robot.
